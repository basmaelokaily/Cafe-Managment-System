...
public class PlaceOrder extends javax.swing.JFrame {
    ...
    public void productNameByCategory(String Category){
     ...
     public void validateFiled(){
         ...
         String CustomerMobileNumber=txtCusNumber.getText();
    ...
    private void initComponents() {
        ...
        blGrandTotal = new javax.swing.JLabel();
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1300, 10, 35, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Bill ID:");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 95, -1, -1));

        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("--");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(89, 96, -1, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Customer Details:");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 130, -1, -1));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Name");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 165, -1, -1));
        ...
        getContentPane().add(txtCusName, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 200, 250, -1));
        ...
        txtCusNumber.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtCusNumber.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtCusNumberKeyReleased(evt);
            }
        });
        getContentPane().add(txtCusNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 300, 250, -1));
        ...
        getContentPane().add(txtCusEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 390, 250, -1));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Category");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(331, 95, -1, -1));
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(331, 131, 250, -1));
        ...
        getContentPane().add(txtSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 200, 250, 20));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(331, 294, 250, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Name");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(638, 105, -1, -1));

        txtProName.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(txtProName, new org.netbeans.lib.awtextra.AbsoluteConstraints(638, 130, 250, -1));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Price");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(947, 105, -1, -1));

        txtProPrice.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(txtProPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(947, 129, 250, -1));

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Quantity");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 160, -1, 20));
        ...
        getContentPane().add(jSpinner1, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 190, 250, -1));
        ...
        getContentPane().add(txtProTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 190, 250, -1));
        ...
        getContentPane().add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 300, -1, -1));
        ...
        getContentPane().add(btnAddToCard, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 300, -1, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 350, 559, 370));

        lable.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lable.setForeground(new java.awt.Color(255, 255, 255));
        lable.setText("Grand Total:Rs.");
        getContentPane().add(lable, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 250, -1, -1));

        blGrandTotal.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        blGrandTotal.setForeground(new java.awt.Color(255, 255, 255));
        blGrandTotal.setText("000");
        getContentPane().add(blGrandTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 250, -1, -1));
        ...
        getContentPane().add(btnGenerateBillPrint, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 300, -1, -1));

        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/full-page-background.PNG"))); // NOI18N
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, 1380, 770));
    ...
    private void btnAddToCardActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCardActionPerformed
        ...
        blGrandTotal.setText(String.valueOf(grandTotal));
        clearProductFields();
        validateFiled();
    ...
    private void btnGenerateBillPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerateBillPrintActionPerformed
        ...
        BillDao.save(bill);
        //Users\\lenovo 520\\Documents\\NetBeansProjects\\Cafe Management System\\src\\file
        String path ="C:\\Users\\lenovo 520\\Documents\\NetBeansProjects\\Cafe Management System\\src";
    ...
    private javax.swing.JLabel blGrandTotal;
